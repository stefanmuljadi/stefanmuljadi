...
const Experience = () => {
    return (
        ...
        <div className="w-full bg-black text-white">
            <div className="px-12 lg:px-24 py-16 z-20 w-full bg-black">
                ...
                <div className="flex flex-col gap-12 h-full">
                    ...
                    <div className="flex flex-col gap-8">
                        <div className='text-2xl lg:text-4xl font-allenoire text-white'>
                            <div className="h-[0.1rem] w-12 bg-white mb-1"></div>
                            2022
                        </div>
                        {/* Company */}
                        <div className="w-full flex flex-col lg:grid grid-cols-6">
                            <div className="col-span-2 text-xl lg:text-3xl font-allenoire text-white">
                                Civtek, <br />Product Director
                            </div>
                            <div className="col-span-4">
                                <ul className="list-disc color-primary font-semibold text-sm">
                        ...
                        <div className="w-full flex flex-col lg:grid grid-cols-6">
                            ...
                            <div className="col-span-4">
                                <ul className="list-disc color-primary font-semibold text-sm justify-between">
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        {/* Company */}
                        <div className="w-full grid grid-rows-flex flex-col lg:2 lg:grid-cols-6">
                            <div className="col-span-2 text-xl lg:text-3xl font-allenoire text-white">
